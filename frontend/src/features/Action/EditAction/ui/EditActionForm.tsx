...
import { useEditActionForm } from '../lib/useEditActionForm';
import {
  Button,
  Loader,
  Stack,
...
export const EditActionForm = ({ action, onClose }: EditActionFormProps) => {
  const {
    initialValues,
    isPending,
    isSegmentsLoading,
    ...
    submitForm,
    getDefaultStrategy,
  } = useEditActionForm({ action, onClose });
                              ...
                              <Stack gap="xs">
                                {strategy.rules && strategy.rules.length > 0 ? (
                                  strategy.rules.map((rule, ruleIndex) => (
                                    <Paper key={ruleIndex} p="xs" withBorder>
                                      <Stack gap="xs">
                                        <Group justify="space-between">
                                          <Text size="xs" fw={500}>
                                            Rule {ruleIndex + 1}
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    pushRule({
                                      ...
                                      not: false,
                                      value: '',
                                    } as EditActionStrategyRuleFormState)
                                  }
                                  disabled={isPending}
                                >
                                  Add Rule
